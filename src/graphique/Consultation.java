...
public class Consultation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Solde du Compte et des caisses");
        ...
        jButton2.setText("Historique des transactions");

        jButton3.setText("Liste des membres");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ListeMembres l = new ListeMembres();
        l.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
       Acceuiluser a = new Acceuiluser();
        a.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ConsulSolde a = new ConsulSolde();
        a.setVisible(true);
        this.dispose();
